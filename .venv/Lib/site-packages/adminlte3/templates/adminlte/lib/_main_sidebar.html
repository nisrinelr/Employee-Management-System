...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    {% block logo %}
        <a href="/" class="brand-link">
            ...
            {% block logo_text %}<span class="brand-text font-weight-light">Employee MS </span>{% endblock %}
        </a>
    {% endblock %}
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{ request.user.profile_picture }" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
